(function () {
  ...
  angular
    ...
    .controller('EstimatedPricesOfOtherPropertiesToTheAmongCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.ElectionExpenseReturnBasedAnalysis='Assets/Liability/Income/Expense Based Analysis - Estimated Prices of other properties to the same candidate';
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIE($scope.electionSeat, $scope.piDonation.limit, 'EstimatedPricesOfOtherPropertiesToTheSameCandidateCrtl').then(function (candidates) {
