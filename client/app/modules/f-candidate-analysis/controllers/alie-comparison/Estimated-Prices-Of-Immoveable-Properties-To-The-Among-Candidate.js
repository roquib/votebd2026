(function () {
  ...
  angular
    ...
    .controller('EstimatedPricesOfImmoveablePropertiesToTheAmongCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.ElectionExpenseReturnBasedAnalysis='Assets/Liability/Income/Expense Based Analysis - Estimated Prices of immoveable properties to the same candidate';
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIE($scope.electionSeat, $scope.piDonation.limit, 'EstimatedPricesOfImmoveablePropertiesToTheSameCandidateCrtl').then(function (candidates) {
