(function () {
  ...
  angular
    ...
    .controller('EstimatedAnnualIncomeOfTheAmongCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.ElectionExpenseReturnBasedAnalysis='Assets/Liability/Income/Expense Based Analysis - Estimated Annual income of the same candidate';
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIE($scope.electionSeat, $scope.piDonation.limit, 'EstimatedAnnualIncomeOfTheSameCandidateCrtl').then(function (candidates) {
