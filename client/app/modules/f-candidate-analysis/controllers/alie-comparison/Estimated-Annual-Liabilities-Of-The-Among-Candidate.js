(function () {
  ...
  angular
    ...
    .controller('EstimatedAnnualLiabilitiesOfTheAmongCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.ElectionExpenseReturnBasedAnalysis='Assets/Liability/Income/Expense Based Analysis - Estimated Annual liabilities of the same candidate';
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIE($scope.electionSeat, $scope.piDonation.limit, 'EstimatedAnnualLiabilitiesOfTheSameCandidateCrtl').then(function (candidates) {
