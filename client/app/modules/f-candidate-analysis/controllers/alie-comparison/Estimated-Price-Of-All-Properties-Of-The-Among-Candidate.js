(function () {
  ...
  angular
    ...
    .controller('EstimatedPriceOfAllPropertiesOfTheAmongCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.ElectionExpenseReturnBasedAnalysis='Assets/Liability/Income/Expense Based Analysis - Estimated Price of all properties of the same candidate';
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIE($scope.electionSeat, $scope.piDonation.limit, 'EstimatedPriceOfAllPropertiesOfTheSameCandidateCrtl').then(function (candidates) {
