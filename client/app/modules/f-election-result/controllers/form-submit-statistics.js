(function () {
  ...
  angular
    ...
    .controller('ElectionResultFormSubmitStatisticsCtrl', function ($scope, elections, currentElections, divisions, electionSeat, ElectionResultService) {

      $scope.$parent.ElectionAnalysisSubTitle="See All Elected Candidate of Any Election - Candidate Form Submission Status";
      ...
      $scope.loadChartData = function () {
        ElectionResultService.getCandidateFormSubmitStatistics($scope.electionSeat, $scope.piDonation.limit, 'EstimatedAnnualExpendituresOfTheSameCandidateCrtl').then(function (ppdata) {
