(function () {
  ...
  angular
    ...
    .controller('EstimatedPricesOfDwellingHousesToTheSameCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AssetsLiabilitiesIncomeExpensesBasedComparision="Assets/Liabilities/Income/Expenses Based Comparision - Estimated Prices of dwelling houses to the same candidate",

      $scope.piDonation = {};     // console.log("in EstimatedPricesOfDwellingHousesToTheSameCandidateCrtl");
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIEComparison($scope.electionSeat, $scope.piDonation.limit, 'EstimatedPricesOfDwellingHousesToTheSameCandidateCrtl').then(function (candidates) {
