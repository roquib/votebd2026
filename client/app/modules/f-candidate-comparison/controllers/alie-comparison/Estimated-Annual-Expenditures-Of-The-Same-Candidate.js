(function () {
  ...
  angular
    ...
    .controller('EstimatedAnnualExpendituresOfTheSameCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AssetsLiabilitiesIncomeExpensesBasedComparision="Assets/Liabilities/Income/Expenses Based Comparision - Estimated Annual expenditures of the same candidate",
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIEComparison($scope.electionSeat, $scope.piDonation.limit, 'EstimatedAnnualExpendituresOfTheSameCandidateCrtl').then(function (candidates) {
