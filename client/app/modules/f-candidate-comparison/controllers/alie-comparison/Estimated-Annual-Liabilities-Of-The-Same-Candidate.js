(function () {
  ...
  angular
    ...
    .controller('EstimatedAnnualLiabilitiesOfTheSameCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AssetsLiabilitiesIncomeExpensesBasedComparision="Assets/Liabilities/Income/Expenses Based Comparision - Estimated Annual liabilities of the same candidate",

      $scope.piDonation = {};     // console.log("in EstimatedAnnualLiabilitiesOfTheSameCandidateCrtl");
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIEComparison($scope.electionSeat, $scope.piDonation.limit, 'EstimatedAnnualLiabilitiesOfTheSameCandidateCrtl').then(function (candidates) {
