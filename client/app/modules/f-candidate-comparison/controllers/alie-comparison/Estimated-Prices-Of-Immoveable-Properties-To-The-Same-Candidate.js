(function () {
  ...
  angular
    ...
    .controller('EstimatedPricesOfImmoveablePropertiesToTheSameCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AssetsLiabilitiesIncomeExpensesBasedComparision="Assets/Liabilities/Income/Expenses Based Comparision - Estimated Prices of immoveable properties to the same candidate",

      $scope.piDonation = {};      //console.log("in EstimatedPricesOfImmoveablePropertiesToTheSameCandidateCrtl");
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIEComparison($scope.electionSeat, $scope.piDonation.limit, 'EstimatedPricesOfImmoveablePropertiesToTheSameCandidateCrtl').then(function (candidates) {
