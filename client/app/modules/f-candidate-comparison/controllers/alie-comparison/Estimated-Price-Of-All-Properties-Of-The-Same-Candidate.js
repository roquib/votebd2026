(function () {
  ...
  angular
    ...
    .controller('EstimatedPriceOfAllPropertiesOfTheSameCandidateCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AssetsLiabilitiesIncomeExpensesBasedComparision="Assets/Liabilities/Income/Expenses Based Comparision - Estimated Price of all properties of the same candidate",

      $scope.piDonation = {};     // console.log("in EstimatedPriceOfAllPropertiesOfTheSameCandidateCrtl");
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getALIEComparison($scope.electionSeat, $scope.piDonation.limit, 'EstimatedPriceOfAllPropertiesOfTheSameCandidateCrtl').then(function (candidates) {
