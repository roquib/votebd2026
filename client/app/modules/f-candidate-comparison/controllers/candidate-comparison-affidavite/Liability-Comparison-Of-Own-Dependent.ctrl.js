(function () {
  ...
  angular
    ...
    .controller('LiabilityComparisonOfOwnDependentCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AffidavitBasedComparision="Affidavit Based Comparision - Liability Comparison of own, dependent"
