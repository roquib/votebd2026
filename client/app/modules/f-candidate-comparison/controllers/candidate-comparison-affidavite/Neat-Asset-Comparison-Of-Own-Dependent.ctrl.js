(function () {
  ...
  angular
    ...
    .controller('NeatAssetComparisonOfOwnDependentCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AffidavitBasedComparision="Affidavit Based Comparision - Neat Asset Comparison of own, dependent"
