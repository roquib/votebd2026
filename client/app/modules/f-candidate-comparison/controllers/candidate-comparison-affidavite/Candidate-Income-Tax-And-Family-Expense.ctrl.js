(function () {
  ...
  angular
    ...
    .controller('CandidateIncomeTaxAndFamilyExpenseCrtl', ["$scope", "$stateParams", "ElectionAnalysisService", function ($scope, $stateParams, ElectionAnalysisService) {

      $scope.$parent.AffidavitBasedComparision="Affidavit Based Comparision - Candidate Income Tax and Family Expense";
    ...
    //  console.log("in EstimatedAnnualExpendituresOfTheSameCandidateCrtl");
      ...
      $scope.loadChartData = function () {
        ...
        ElectionAnalysisService.getCandidateAffidavitComparison($scope.electionSeat, $scope.piDonation.limit, 'CandidateIncomeTaxAndFamilyExpenseCrtl').then(function (candidates) {
