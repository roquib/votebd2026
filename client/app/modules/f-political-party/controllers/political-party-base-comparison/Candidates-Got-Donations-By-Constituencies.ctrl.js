(function () {
  ...
  angular
    ...
    .controller('CandidatesGotDonationsByConstituenciesCrtl', ["$scope", "$stateParams", "$rootScope", "ElectionAnalysisService", function ($scope, $stateParams, $rootScope, ElectionAnalysisService) {

      $scope.$parent.PoliticalPartySubTitle = 'Political Party Based Comparison - Candidates, got donations(by Constituencies)';

      $scope.piDonation = {};
      // console.log("in CandidatesGotDonationsByConstituenciesCrtl");
