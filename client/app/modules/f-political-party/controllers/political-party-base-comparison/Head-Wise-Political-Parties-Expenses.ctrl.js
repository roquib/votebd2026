(function () {
  ...
  angular
    ...
    .controller('HeadWisePoliticalPartiesExpensesCrtl', ["$scope", "$stateParams", "$rootScope","ElectionAnalysisService", function ($scope, $stateParams, $rootScope, ElectionAnalysisService) {

      $scope.$parent.PoliticalPartySubTitle = 'Political Party Based Comparison - Head wise Political parties Expenses';

      $scope.piDonation = {};
      // console.log("in HeadWisePoliticalPartiesExpenses");
