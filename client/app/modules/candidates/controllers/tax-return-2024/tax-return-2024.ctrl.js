            ...
            if (
              ...
              CandidatesService.getCandidate($stateParams.candidateId).then(
                function (candidate) {
                  ...
                  $scope.gotCandidate.dobTR = new Date(
                    $scope.gotCandidate.dobTR
                  );
                  $scope.gotCandidate.endDateTR = new Date(
                    $scope.gotCandidate.endDateTR
                  );
                }
              );
            }
                ...
                if (
                  ...
                  CoreService.toastSuccess(
                    ...
                    gettextCatalog.getString(
                      "Your Candidate Tax return form is save with us"
                    )
                  );
