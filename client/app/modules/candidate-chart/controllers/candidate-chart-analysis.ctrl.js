(function () {
  ...
  angular
    ...
    .controller('CandidateChartCtrl', ["$scope", "elections", "currentElections", "divisions", "CandidateChartAnalysisService", "electionSeat", function ($scope, elections, currentElections, divisions, CandidateChartAnalysisService, electionSeat) {
      ...
      this.formFields = CandidateChartAnalysisService.getFormFilter(elections, currentElections, divisions, electionSeat);
      this.formOptions = {};
