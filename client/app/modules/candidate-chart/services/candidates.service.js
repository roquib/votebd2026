(function () {
  ...
  angular
    ...
    .service('CandidateChartAnalysisService', function (CoreService, Candidate, CurrentElection, $filter, gettextCatalog, $rootScope, ElectionsServiceForES) {
      ...
      this.getCurrentElectionWhere = function (electionSeatCriteria,id) {
        var whereCriteria = {};
        ...
        //console.log("whereCriteria", whereCriteria.currentElectionId);

        var currentElectionId=whereCriteria.currentElectionId;
      ...
      this.getCandidatesAssetWhere = function (electionSeatCriteria) {
        var whereCriteria = this.verifyFilterData(electionSeatCriteria);
        return Candidate.getAssetChart({whereCriteria: whereCriteria, type: $rootScope.locale.lang}).$promise;
      };
