...
//oldds.discoverSchema('election_list', {schema: 'votebd_reorganize_2016'}, function(err,schema) {
//  if (err) throw err;
//
...
////Step 2: Showing data
//oldds.discoverAndBuildModels('election_list', {schema: 'votebd_reorganize_2016'},
//  function(err, models) {
//    if (err) throw err;
//
