...
//oldds.discoverSchema('election_posts', {schema: 'votebd_reorganize_2016'}, function(err,schema) {
//  if (err) throw err;
//
...
////Step 2: Showing data
//oldds.discoverAndBuildModels('election_posts', {schema: 'votebd_reorganize_2016'},
//  function(err, models) {
//    if (err) throw err;
//
...
//
//
//        app.models.electionCandidatePost.create(distr, function(err, model) {
//          if (err) throw err;
//
...
//now put currentElection objectId to district(districtId)
  app.models.currentElection.find(function(err, currentElections) {
    ...
    currentElections.forEach(function(currentElection) {
      ...
      app.models.electionCandidatePost.updateAll({oldCurrentElectionId: currentElection.oldId}, distr, function(errr, info) {
        if(err)
          throw errr;
