...
//oldds.discoverSchema('election_seat_list', {schema: 'votebd_reorganize_2016'}, function(err,schema) {
//  if (err) throw err;
//
...
//Step 2: Showing data
//oldds.discoverAndBuildModels('election_seat_list', {schema: 'votebd_reorganize_2016'},
//  function(err, models) {
//    if (err) throw err;
//
...
//      console.log('adding currentElection reference to election seat');
//
//
//      //importing to mongo
