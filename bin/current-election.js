...
//oldds.discoverSchema('current_elections', {schema: 'votebd_reorganize_2016'}, function(err,schema) {
//  if (err) throw err;
//
...
////Step 2: Showing data
//oldds.discoverAndBuildModels('current_elections', {schema: 'votebd_reorganize_2016'},
//  function(err, models) {
//    if (err) throw err;
//
